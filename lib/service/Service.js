...
class Service {
  ...
  async resolveConfig() {
    ...
    // await this.emitHooks(constant.HOOK_CONFIG_RESOLVED);
    // console.log(configFilePath)
    // 修改: const entry = this.webpackConfig.entry('index')
    ...
    this.webpackConfig.plugin('clean')
        .use('webpack-chain', [{
            root: '/dir'
        }])
    console.log('webpackconfig', this.webpackConfig.toConfig())
  }
